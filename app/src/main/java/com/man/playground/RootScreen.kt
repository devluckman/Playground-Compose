...
import com.man.core.DestinationRoute.COMMENT_BOTTOM_SHEET_ROUTE
import com.man.core.DestinationRoute.FORMATTED_COMPLETE_CREATOR_VIDEO_ROUTE
...
import com.man.playground.component.BottomBar
import com.man.playground.navigation.AppNavHost
        ...
        ModalBottomSheetLayout(bottomSheetNavigator = bottomSheetNavigator) {
            Scaffold(
                ...
                bottomBar = {
                    ...
                    BottomBar(navController, currentDestination, darkMode)
                }
            ) {
                Column(
                    modifier = Modifier
